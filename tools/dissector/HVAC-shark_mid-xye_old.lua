...
-- ── Load glossary-generated decode tables (if available) ────────────────────
-- Generated by generate_dissector_tables.py from serial_glossary.yaml.
-- The generated file defines glossary_decode_c0() and related functions.
-- If the file is missing, the dissector works normally without glossary decode.
local _gen_dir = debug.getinfo(1, "S").source:match("@(.*/)")
if _gen_dir then pcall(dofile, _gen_dir .. "hvac_shark_glossary_gen.lua") end
